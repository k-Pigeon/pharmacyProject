...
<%
    // 데이터베이스 연결 설정
    String url = "jdbc:mysql://localhost:3306/tutorial2?useUnicode=true&characterEncoding=utf8"; // 데이터베이스 URL
    ...
    try {
        ...
        String query = " SELECT * FROM testTable WHERE medicineName = ? AND inventory > 0 "
