    ...
    if (nameSearch != null && !nameSearch.trim().isEmpty()) {
        ...
        try {
            ...
            String sql = " SELECT medicineName, price, inventory, wholesaler, companyName, standard, receiptDate, DeliveryDate, returnInv "
            		   ...
            		   + " ORDER BY medicineName ASC, DeliveryDate ASC";
