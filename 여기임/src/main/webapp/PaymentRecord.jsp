...
#wrap #flex_screen .leftScreen, #wrap #flex_screen .rightScreen {
	display: block;
	flex: 1;
	width: 100%;
	height: 100%;
...
.filter_UI #selectPhone, .filter_UI #selectName {
	height: 40px;
	width: 210px;
	font-size: 20px;
}
...
/* Memo란 스타일링 */
textarea.personalMemo, textarea.salesMemo {
	display: block;
	width: 80%;
	height: 25%;
	margin: 20px auto; /* 수평 중앙 정렬 및 간격 */
...
/* Memo란 포커스 상태 스타일링 */
textarea.personalMemo:focus, textarea.salesMemo:focus {
	border-color: #007bff; /* 포커스 시 테두리 색상 변경 */
	outline: none; /* 기본 포커스 효과 제거 */
}

#wrap #flex_screen .leftScreen .memoAjax, #wrap #flex_screen .rightScreen .memoAjax	{
    border: 1px solid black;
	display: block;
	width: 80%;
	height: 7%;
...
<body>
	...
	<h1
		style="position: fixed; top: 7%; width: 100%; height: 50px; text-align: center;">판매내역</h1>
	<div class="filter_UI">
	...
	<div id="wrap">
		<div id="flex_screen">
			<div class="leftScreen">
				...
				<textarea class="personalMemo"
					style="display: block; width: 80%; height: 25%; border: 1px solid black; resize: none; border-radius: 10px 10px 0 0; box-shadow: 0px 0px 5px black; padding: 0; margin: 0 auto;"></textarea>
				<input type="button" class="memoAjax" value="저장"
					name="individualMemo">
				<table>
					<thead>
						<tr>
