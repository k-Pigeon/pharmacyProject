...
<%
    ...
    try {
        ...
        String sql = " SELECT medicineName, companyName, standard, kind,  "
	 			   + " FORMAT(inventory, 0) AS inventory, serialNumber, "
  				   + " receiptDate, deliveryDate, "
	 			   + " FORMAT(buyingprice, 0) AS buyingprice, FORMAT(price, 0) AS price "
			       + " FROM testTable "
