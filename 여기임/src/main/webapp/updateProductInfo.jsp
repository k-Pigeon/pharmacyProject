...
try {
    ...
    // 기존 데이터 삭제
    String deleteSql = "DELETE FROM RegistTable WHERE medicineName = ?";
    ...
    String insertRegistSql = "INSERT INTO RegistTable (medicineName, standard, buyingPrice, price, countNumber, lowerAndHigest) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    for (int i = 0; i < productList.length(); i++) {
        ...
        String lowerandhigest = item.getString("lowerAndHigest");
        ...
        insertRegistStmt.setString(6, lowerandhigest);
