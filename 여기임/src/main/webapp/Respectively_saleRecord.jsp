...
try {
	...
	String sql = "SELECT saleDate, (inventory / REGEXP_REPLACE(standard, '[^0-9]+', '')) AS letters, price, (inventory * price) AS sumPrice, DeliveryDate FROM SalesRecord WHERE medicineName = ?";
