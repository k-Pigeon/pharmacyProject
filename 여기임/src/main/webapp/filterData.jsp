...
<%
    ...
    if (filterValue != null && !filterValue.trim().isEmpty()) {
        try {
            months = Integer.parseInt(filterValue); // 숫자로 변환
    ...
    try {
        ...
        cal.add(Calendar.MONTH, months); // N개월 후 계산
        String endDate = sdf.format(cal.getTime()); // 종료 날짜
        ...
        pstmt.setString(1, today); // 시작 날짜
        pstmt.setString(2, endDate); // 종료 날짜
