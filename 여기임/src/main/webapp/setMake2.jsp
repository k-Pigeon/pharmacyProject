...
<body>
	<div id="wrap">
		...
		<table class="table_line" id="table_input"
			...
			<tr>
				<td><input type="text" id="productName1" name="productName1"
	...
	<script>
		$(document).ready(function(){
		    $(".setMakeAjax").click(function () {
		        ...
		        var standard = $(".standard").val();  // saleInventory 값이 됨
