...
String idSortation = (session != null) ? (String) session.getAttribute("idSortation") : "";
String sql = "UPDATE testTable" + idSortation
		+ " SET isOrdered = 1 WHERE medicineName=? AND DeliveryDate=? AND domain_type = ? ";
