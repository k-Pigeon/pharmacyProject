...
request.setCharacterEncoding("UTF-8");
    ...
    try {
        ...
        if (rs.next()) {
            ...
            String updateSql = "UPDATE members SET memoInfo = ? WHERE id = ? AND domain_type = ? ";
            ...
            String maxSql = "SELECT MAX(id) AS maxId, MAX(customerNumber) AS maxCustNum FROM members where domain_type = ? ";
