...
<%
    ...
    try {
        ...
        out.print("Invalid filter value");
        return;
    }
    ...
    try {
        ...
        String sql =
            "SELECT medicineName, quantity, price, inventory AS realInv, " +
...
<tr>
    ...
    <td>
        ...
        <button type="button" class="deleteInfo">삭제</button>
    </td>
    ...
    <td>
        <input type="button"
               class="returnProduct"
               value="<%= (rs.getInt("returnInv") == 1) ? "반품됨" : "반품하기" %>">
    </td>
</tr>
<%
        }
