...
try{
	...
	// 전체 행 개수
	PreparedStatement countStmt = conn.prepareStatement("SELECT COUNT(*) FROM testTable where domain_type = ?");
	...
	// 실제 데이터 조회
	String sql = "SELECT *, format(price, 0) AS realPrice FROM testTable" +
				 " where domain_type = ? " +
