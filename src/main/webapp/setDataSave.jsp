...
try {
    ...
    if (setType.equals("product")) {
        ...
        String sqlSet = "INSERT INTO productSet (setName, buyingprice, price, inventory, domain_type) VALUES (?, ?, ?, ?, ?)";
        ...
        String sqlDetail = "INSERT INTO productSet_detail (productSet_id, medicineName, standard, domain_type) VALUES (?, ?, ?, ?)";
        ...
        for (int i = 0; i < products.length(); i++) {
            ...
            psDetail.setString(4, domainType);
            psDetail.addBatch();
        }
        ...
        String sqlRegular = "INSERT INTO regularSet (setName, medicineName, Buyingprice, price, inventory, standard, domain_type) VALUES (?, ?, ?, ?, ?, ?, ?)";
